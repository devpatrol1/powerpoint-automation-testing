...
for WEEK in LIST_WEEKS:    
    ...
    left = Inches(0.75)
    top = Inches(1.25)
    pic = slide.shapes.add_picture('images/{}.png'.format(WEEK), left, top, height=Inches(4.5))
    # Build the Text Box
    left = Inches(0.75)
...
left = Inches(0.75)
top = Inches(1.25)
pic = slide.shapes.add_picture('images/{}.png'.format('SPLIT'), left, top, height=Inches(4.5))
# Build the Text Box
left = Inches(0.75)
top = Inches(1.5) + Inches(4)
width = Inches(9)
...
# Save
prs.save('ppt_files/Warehouse Workload Report.pptx')
